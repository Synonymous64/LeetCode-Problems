...
const mergePDF = async (sample1, sample2) => {
    await merger.add(sample1);  //merge all pages. parameter is the path to file and filename.
    await merger.add(sample2);
    // await merger.add('sample2.pdf', 2); // merge only page 2
